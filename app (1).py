...
json_file1 = open('C:\\Users\\alsaf\\Downloads\\Image_Colorization-main\\modelGenerator.json', 'r')
loaded_model_json1 = json_file1.read()
json_file1.close()
model1 = tf.keras.models.model_from_json(loaded_model_json1)
model1.load_weights("modelGen.h5")
print("Loaded model 1 from disk")

# Loading The GANs model
json_file2 = open('C:\\Users\\alsaf\\Downloads\\Image_Colorization-main\modelDescriminator.json', 'r')
loaded_model_json2 = json_file2.read()
json_file2.close()
model2 = tf.keras.models.model_from_json(loaded_model_json2)
model2.load_weights("modelDis.h5")
